...
class SensorTemplateCatalog {
  static final List<SensorTemplate> generalSensors = [
    ...
    SensorTemplate(
      ...
      type: 'pm25',
      unit: 'ug/m3',
      iconCode: Icons.blur_on.codePoint,
      minValue: 0,
      maxValue: 500,
      step: 1,
      defaultValue: 18,
    ...
    SensorTemplate(
      ...
      type: 'rain',
      unit: 'mm',
      iconCode: Icons.grain.codePoint,
      minValue: 0,
      maxValue: 50,
      step: 0.1,
      defaultValue: 0,
    ...
    SensorTemplate(
      ...
      type: 'noise',
      unit: 'dB',
      iconCode: Icons.graphic_eq.codePoint,
      minValue: 0,
      maxValue: 120,
      step: 1,
      defaultValue: 35,
    ...
    SensorTemplate(
      ...
      type: 'energy',
      unit: 'kWh',
      iconCode: Icons.battery_charging_full.codePoint,
      minValue: 0,
      maxValue: 100000,
      step: 0.1,
      defaultValue: 0,
    ...
    SensorTemplate(
      ...
      type: 'battery',
      unit: '%',
      iconCode: Icons.battery_std.codePoint,
      minValue: 0,
      maxValue: 100,
      step: 1,
      defaultValue: 78,
